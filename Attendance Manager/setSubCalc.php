...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="setSubCalc.php">Calculate</a></li>
    </ul>
...
$query = "Select s.name
 ...
 $i=0;
  ...
  $i=0;
  echo '<form action="calcdata.php" method="GET" id="selsub" name="selsub"><div class="form-group">';
  echo '<h1>Calculate data</h1><br><br>';
